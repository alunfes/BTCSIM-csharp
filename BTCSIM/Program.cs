    ...
    class MainClass
    {
        public static void Main(string[] args)
        {
            ...
            if (key == "sim")
            {
                ...
                var ac = ga.sim_ga_market_limit(from, to, max_amount, chromo, from.ToString() + " - " + to.ToString() + ", dt:" + MarketData.Dt[from].ToString() + " - " + MarketData.Dt[to - 1], true);
